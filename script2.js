...
let addProd7 = document.getElementById('addProd7');

addProd7.addEventListener('click', () => {
    amount7 += 1;
    products[6].price = parseInt(products[6].price)
    products[6].price += 95;
    products[6].amount = parseInt(products[6].amount)
    products[6].amount += 1;
    total += 95;
    localStorage.setItem('description7', products[6].description);
    localStorage.setItem('price7', parseInt(products[6].price));
    localStorage.setItem('amount7', parseInt(products[6].amount));
    localStorage.setItem('total', total);
    prod7Cart.textContent = `${localStorage.getItem('description7')} (X${parseInt(localStorage.getItem('amount7'))}) $${parseInt(localStorage.getItem('price7'))}`;
    if(products[6].price == 95) {
    prod7Cart.insertAdjacentHTML('afterend', `<div id='remove7Btn'><button onclick='remove7()'>Remove</button></div>`);
    remove7Btn = document.getElementById('remove7Btn');
    localStorage.setItem('remove7Btn', remove7Btn)
    }
});
...
let addProd8 = document.getElementById('addProd8');

addProd8.addEventListener('click', () => {
  products[7].amount = parseInt(products[7].amount)
  amount8 += 1;
  products[7].price = parseInt(products[7].price)
  products[7].price += 849;
  products[7].amount += 1;
  total += 849;
  localStorage.setItem('description8', products[7].description);
  localStorage.setItem('price8', parseInt(products[7].price));
  localStorage.setItem('amount8', parseInt(products[7].amount));
  localStorage.setItem('total', total);
  prod8Cart.textContent = `${localStorage.getItem('description8')} (X${parseInt(localStorage.getItem('amount8'))}) $${parseInt(localStorage.getItem('price8'))}`
  if(products[7].price == 849) {
  prod8Cart.insertAdjacentHTML('afterend', `<div id='remove8Btn'><button onclick='remove8()'>Remove</button></div>`);
  remove8Btn = document.getElementById('remove8Btn');
  localStorage.setItem('remove8Btn', remove8Btn)
  }
});
...
let addProd9 = document.getElementById('addProd9');

addProd9.addEventListener('click', () => {
  amount9 += 1;
  products[8].price = parseInt(products[8].price)
  products[8].price += 125;
  products[8].amount = parseInt(products[8].amount)
  products[8].amount += 1;
  total += 125;
  localStorage.setItem('description9', products[8].description);
  localStorage.setItem('price9', products[8].price);
  localStorage.setItem('amount9', products[8].amount);
  localStorage.setItem('total', total);
  prod9Cart.textContent = `${localStorage.getItem('description9')} (X${parseInt(localStorage.getItem('amount9'))}) $${parseInt(localStorage.getItem('price9'))}`
  if(products[8].price == 125) {
  prod9Cart.insertAdjacentHTML('afterend', `<div id='remove9Btn'><button onclick='remove9()'>Remove</button></div>`);
  remove9Btn = document.getElementById('remove9Btn');
  localStorage.setItem('remove9Btn', remove9Btn)
  }
});
...
let addProd10 = document.getElementById('addProd10');

addProd10.addEventListener('click', () => {
  amount10 += 1;
  products[9].price = parseInt(products[9].price)
  products[9].price += 999;
  products[9].amount = parseInt(products[9].amount)
  products[9].amount += 1;
  total += 999;
  localStorage.setItem('description10', products[9].description);
  localStorage.setItem('price10', products[9].price);
  localStorage.setItem('amount10', products[9].amount);
  localStorage.setItem('total', total);
  prod10Cart.textContent = `${localStorage.getItem('description10')} (X${parseInt(localStorage.getItem('amount10'))}) $${parseInt(localStorage.getItem('price10'))}`
  if(products[9].price == 999) {
  prod10Cart.insertAdjacentHTML('afterend', `<div id='remove10Btn'><button onclick='remove10()'>Remove</button></div>`);
  remove10Btn = document.getElementById('remove10Btn');
  localStorage.setItem('remove10Btn', remove10Btn)
  }
});
...
let addProd11 = document.getElementById('addProd11');

addProd11.addEventListener('click', () => {
  amount11 += 1;
  products[10].price = parseInt(products[10].price)
  products[10].price += 35;
  products[10].amount = parseInt(products[10].amount)
  products[10].amount += 1;
  total += 35;
  localStorage.setItem('description11', products[10].description);
  localStorage.setItem('price11', products[10].price);
  localStorage.setItem('amount11', products[10].amount);
  localStorage.setItem('total', total);
  prod11Cart.textContent = `${localStorage.getItem('description11')} (X${parseInt(localStorage.getItem('amount11'))}) $${parseInt(localStorage.getItem('price11'))}`
  if(products[10].price == 35) {
  prod11Cart.insertAdjacentHTML('afterend', `<div id='remove11Btn'><button onclick='remove11()'>Remove</button></div>`);
  remove11Btn = document.getElementById('remove11Btn');
  localStorage.setItem('remove11Btn', remove11Btn)
  }
});
...
let addProd12 = document.getElementById('addProd12');

addProd12.addEventListener('click', () => {
  amount12 += 1;
  products[11].price = parseInt(products[11].price)
  products[11].price += 1299;
  products[11].amount = parseInt(products[11].amount)
  products[11].amount += 1;
  total += 1299;
  localStorage.setItem('description12', products[11].description);
  localStorage.setItem('price12', products[11].price);
  localStorage.setItem('amount12', products[11].amount);
  localStorage.setItem('total', total);
  prod12Cart.textContent = `${localStorage.getItem('description12')} (X${parseInt(localStorage.getItem('amount12'))}) $${parseInt(localStorage.getItem('price12'))}`
  if(products[11].price == 1299) {
  prod12Cart.insertAdjacentHTML('afterend', `<div id='remove12Btn'><button onclick='remove12()'>Remove</button></div>`);
  remove12Btn = document.getElementById('remove12Btn');
  localStorage.setItem('remove12Btn', remove12Btn)
  }
});
